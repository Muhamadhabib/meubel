                    ...
                    <div class="body">
                        ...
                        <?php $n = 1; foreach($trs as $b) : ?>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url();?>/penjualan/del_trans/<?= $b['id_trans'] ?>" class="btn btn-danger btn-sm waves-effect"onclick="return confirm('yakin?');" ><i class="material-icons">delete</i></a>
                            </td>
                            </tr>
                            </form>
                        <?php endforeach; ?>
